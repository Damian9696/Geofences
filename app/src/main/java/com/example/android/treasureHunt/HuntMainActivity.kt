 ...
 */
    ...
    override fun onRequestPermissionsResult(
        ...
        if (isNeededPermissionDenied(grantResults, requestCode)) {
    ...
    private fun isNeededPermissionDenied(grantResults: IntArray, requestCode: Int): Boolean {
    ...
    private fun showSnackbarWithExplanation() {
        Snackbar.make(
    ...
    private fun checkDeviceLocationSettingsAndStartGeofence(resolve: Boolean = true) {
        ...
        locationSettingsResponseTask.addOnFailureListener { exception ->
            if (exception is ResolvableApiException && resolve) {
                ...
                showSnackbarLocationNeedToBeEnabled()
            }
        }
    ...
    private fun showSnackbarLocationNeedToBeEnabled() {
        Snackbar.make(
            binding.activityMapsMain,
    ...
    private fun foregroundAndBackgroundLocationPermissionApproved(): Boolean {
        val foregroundLocationApproved = isForegroundLocationPermission()
        val backgroundPermissionApproved = isBackgroundLocationPermission()
        return foregroundLocationApproved && backgroundPermissionApproved
    }

    @RequiresApi(Build.VERSION_CODES.Q)
    private fun isBackgroundLocationPermission(): Boolean {
    ...
    private fun isForegroundLocationPermission(): Boolean {
